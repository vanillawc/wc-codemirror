...
`);self.CodeMirror=ar;var ur=class extends HTMLElement{static get observedAttributes(){return["src","readonly","mode","theme"]}attributeChangedCallback(t,i,r){!this.__initialized||i!==r&&(t==="readonly"?this[t]=r!==null:this[t]=r)}get readonly(){return this.editor.getOption("readOnly")}set readonly(t){this.editor.setOption("readOnly",t)}get mode(){return this.editor.getOption("mode")}set mode(t){this.editor.setOption("mode",t)}get theme(){return this.editor.getOption("theme")}set theme(t){this.editor.setOption("theme",t)}get src(){return this.getAttribute("src")}set src(t){this.setAttribute("src",t),this.setSrc()}get value(){return this.editor.getValue()}set value(t){this.setValue(t)}constructor(){super();let t=document.createElement("template");t.innerHTML=ur.template(),this.appendChild(t.content.cloneNode(!0)),this.__initialized=!1,this.__element=null,this.editor=null}async connectedCallback(){this.style.display="block",this.__element=this.querySelector("textarea");let t=this.hasAttribute("mode")?this.getAttribute("mode"):"null",i=this.hasAttribute("theme")?this.getAttribute("theme"):"default",r=this.getAttribute("readonly");r===""?r=!0:r!=="nocursor"&&(r=!1);let l="",n=this.querySelector("script");n&&n.getAttribute("type")==="wc-content"&&(l=ur.dedentText(n.innerHTML),l=l.replace(/&lt;(\/?script)(.*?)&gt;/g,"<$1$2>"));let o=ar.defaults.viewportMargin;if(this.hasAttribute("viewport-margin")){let s=this.getAttribute("viewport-margin").toLowerCase();o=s==="infinity"?Infinity:parseInt(s)}this.editor=ar.fromTextArea(this.__element,{lineNumbers:!0,readOnly:r,mode:t,theme:i,viewportMargin:o}),this.hasAttribute("src")?this.setSrc(this.getAttribute("src")):(await new Promise(s=>setTimeout(s,50)),this.value=l),this.__initialized=!0}disconnectedCallback(){this.editor&&this.editor.toTextArea(),this.editor=null,this.__initialized=!1}async setSrc(){let t=this.getAttribute("src"),i=await this.fetchSrc(t);this.value=i}async setValue(t){this.editor.swapDoc(ar.Doc(t,this.getAttribute("mode"))),this.editor.refresh()}async fetchSrc(t){return(await fetch(t)).text()}static template(){return`
      <textarea style="display:inherit; width:inherit; height:inherit;"></textarea>
    `}static dedentText(t){let i=t.split(`
